...
@section('modal-button')
    <div id="add-sales-btn" class="px-4 py-2 rounded-md bg-gray-100 border-2 border-gray-300 cursor-pointer hover:bg-gray-200 transition">Create Quotation</div>
                    ...
                    <form>
                        ...
                        <div class="max-w-4xl mx-auto border border-dashed border-gray-400 p-6 bg-gray-100 ">
                            <div class="flex justify-between mb-4">
                                <span class="px-3 py-1 border border-gray-400 bg-white text-sm font-semibold">
                                    Order Lines
                                </span>
                                <span class="px-3 py-1 border border-gray-400 bg-white text-sm font-semibold">
                            ...
                            <table class="w-full text-left text-sm">
                                ...
                                <tbody>
                                    <tr class="text-gray-700">
                                        ...
                                        <td class="py-2">2,800.00</td>
                                        <td class="py-2">10 %</td>
                                        <td class="py-2 text-right">2,800.00</td>
                                    </tr>
                                </tbody>
                            </table>

                            <div class="flex gap-6 text-blue-600 text-sm mt-3">
                                <a href="#" class="px-4 py-2 rounded-md bg-gray-100 border-2 border-gray-300 cursor-pointer hover:bg-gray-200 transition">Add a product</a>
                                <a href="#" class="px-4 py-2 rounded-md bg-gray-100 border-2 border-gray-300 cursor-pointer hover:bg-gray-200 transition">Add a section</a>
                                <a href="#" class="px-4 py-2 rounded-md bg-gray-100 border-2 border-gray-300 cursor-pointer hover:bg-gray-200 transition">Add a note</a>
                                <a href="#" class="px-4 py-2 rounded-md bg-gray-100 border-2 border-gray-300 cursor-pointer hover:bg-gray-200 transition">Catalog</a>
                            </div>

                            <div class="flex justify-end mt-6">
                                <div class="text-sm text-right space-y-1">
                                    <div>Untaxed Amount : <span class="font-medium">$ 2,800.00</span></div>
                                    <div>GST 10% : <span class="font-medium">$ 280.00</span></div>
                                    <div class="font-semibold">Total : $ 3,080.00</div>
                                </div>
                            </div>
                        </div>
